...
/***/ function(module, exports, __webpack_require__) {
	...
	function render(err, authData) {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(App, { auth: authData }), document.getElementById('content'));
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactfire = __webpack_require__(187);
	...
	var SignupForm = __webpack_require__(190);
	var Queue = __webpack_require__(276);
	var CurrentStatus = __webpack_require__(277);
	
	var helpRef = new _firebase2.default('https://ee109.firebaseio.com/help');
	var checkoffRef = new _firebase2.default('https://ee109.firebaseio.com/checkoff');
	var usersRef = new _firebase2.default('https://ee109.firebaseio.com/users');
	...
	var App = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    if (this.state.users && this.state.users[this.props.auth.uid]) {
	      var isAdmin = this.state.users[this.props.auth.uid].admin;
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'h1',
	          null,
	          'https://vinnie.io/ee109'
	        ),
	        _react2.default.createElement(SignupForm, { onSubmit: this.onSubmit }),
	        _react2.default.createElement(CurrentStatus, { uid: this.props.auth.uid, help: this.state.helpQueue, checkoff: this.state.checkoffQueue }),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(Queue, { entries: this.state.helpQueue,
	              admin: isAdmin,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(Queue, { entries: this.state.checkoffQueue,
	              admin: isAdmin,
	    ...
	    // new user, ask for their name first
	        ...
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { placeholder: 'Your name', value: this.state.name, onChange: function onChange(e) {
	  ...
	  _submitName: function _submitName() {
	  ...
	  _deleteHelp: function _deleteHelp(entry) {
	    helpRef.child(entry['.key']).remove();
	  },
	
	  _deleteCheckoff: function _deleteCheckoff(entry) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".app-styles-app---queueWrapper---1mkuz {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n}\n\n.app-styles-app---queue---o382L {\n  display: flex;\n  flex-direction: column;\n}\n", ""]);
	
	// exports
	exports.locals = {
		"queueWrapper": "app-styles-app---queueWrapper---1mkuz",
		"queue": "app-styles-app---queue---o382L"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SignupForm = function (_Component) {
	  ...
	  function SignupForm(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SignupForm).call(this, props));
	  ...
	  (0, _createClass3.default)(SignupForm, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", { type: "radio", checked: this.state.help, onChange: function onChange(e) {
	            return _this2.setState({ help: e.target.value });
	          } }),
	        "Help ",
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(202)('getPrototypeOf', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var create         = __webpack_require__(233)
	  , descriptor     = __webpack_require__(215)
	  , setToStringTag = __webpack_require__(245)
	  , IteratorPrototype = {};
	
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(206)(IteratorPrototype, __webpack_require__(246)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(207).f
	  , has = __webpack_require__(197)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(200)
	  , hide          = __webpack_require__(206)
	  , Iterators     = __webpack_require__(231)
	  , TO_STRING_TAG = __webpack_require__(246)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.f = __webpack_require__(246);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var META     = __webpack_require__(201)('meta')
	  ...
	  , has      = __webpack_require__(197)
	  , setDesc  = __webpack_require__(207).f
	  , id       = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(200)
	  ...
	  , wksExt         = __webpack_require__(251)
	  , defineProperty = __webpack_require__(207).f;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(204)(Function.call, __webpack_require__(264).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Queue = function (_Component) {
	  (0, _inherits3.default)(Queue, _Component);
	
	  function Queue(props) {
	    (0, _classCallCheck3.default)(this, Queue);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Queue).call(this, props));
	  }
	  ...
	  (0, _createClass3.default)(Queue, [{
	    ...
	    key: '_renderDelete',
	    value: function _renderDelete(e) {
	      if (this.props.admin || this.props.uid === e.uid) {
	        return _react2.default.createElement(
	          'button',
	          { onClick: this.props.onDelete.bind(null, e) },
	          'x'
	        );
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CurrentStatus = function (_Component) {
	  (0, _inherits3.default)(CurrentStatus, _Component);
	
	  function CurrentStatus() {
	    (0, _classCallCheck3.default)(this, CurrentStatus);
	    return (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(CurrentStatus).apply(this, arguments));
	  }
	
	  (0, _createClass3.default)(CurrentStatus, [{
	    key: 'render',
	    value: function render() {
	      var helpIndex = -1;
	      var checkoffIndex = -1;
	      ...
	      var helpString = helpIndex == -1 ? 'You are not in line for help ' : 'You are #' + helpIndex + ' in line for help';
	      var checkoffString = checkoffIndex == -1 ? 'You are not in line to be checked off ' : 'You are #' + checkoffIndex + ' in line to be checked off';
	      return _react2.default.createElement(
	        'span',
	        null,
	        helpString,
